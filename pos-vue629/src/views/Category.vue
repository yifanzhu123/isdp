...
<el-form :model="queryParams" ref="queryForm" :inline="true" label-width="68px">
  <el-form-item label="编号" prop="categoryId">
    <el-input v-model="queryParams.categoryId" placeholder="请输入类别编号" clearable size="small" @keyup.enter.native="handleQuery" />
  </el-form-item>
...
<el-table v-loading="loading" :data="dataList" @selection-change="handleSelectionChange">
  ...
  <el-table-column label="类别编号" align="center" prop="categoryId" width="55" />
...
<el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
  <el-form ref="form" :model="form" :rules="rules" label-width="80px">
    <el-form-item label="类别编号" prop="categoryId">
      <el-input v-model="form.categoryId" placeholder="请输入编号" />
    </el-form-item>
...
import { listCategoryByPage, delCategory, addCategory, getCategory, updateCategory } from "@/api/category";
export default {
  name: "Product",
  // 定义属性
  data() {
